subroutine lsvecopt(evalf,evalg,quadstep,stp,stmin,stmax,m,mquad,      &
					mnquad,quadratic,quadind,nquadind,f0,g0,ftol,gtol, &
...
!	algorithm for vector optimization", technical report, 2018.
!	
...
!
	...
	real(kind=8), parameter :: zero = 0.0d0, one = 1.0d0, two = 2.0d0,   &
	                           smallnum = -1.0d20, bignum = 1.0d+99
